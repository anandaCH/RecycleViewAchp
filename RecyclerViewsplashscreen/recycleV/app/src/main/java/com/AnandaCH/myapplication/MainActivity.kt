...
import com.AnandaCH.myapplication.databinding.ActivityMainBinding
import com.AnandaCH.myapplication.model.Pemain
import com.AnandaCH.myapplication.model.adapter.AdapterTeamBola
    ...
    binding.list.adapter = AdapterTeamBola(this,listPemain,object : AdapterTeamBola.OnClickListener{
        override fun detailData(item: Pemain?) {
            Dialog(this@MainActivity).apply {
                ...
                val tinggi = this.findViewById<TextView>(R.id.txtTinggu)
